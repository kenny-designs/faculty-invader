/** ALL CODE HERE IS FOR REFERENCE IN DEVELOPING THE NEW INDEX.JS */
...
const config = {
  ...
  scene: {
    ...
    create: create
    //update: update
    //render: render TODO: render not in config anymore
  }
};
...
/**
 * Preload images and sphresheets for the game scene
 */ 
function preload() {
  // load images
...
function create() {
  ...
  this.add.text(800 - 100, 10, 'Lives : ', { font: '34px Arial', fill: '#fff' });
